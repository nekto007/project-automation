...
INSTALLED_APPS = [
    ...
    'projectautomation.apps.ProjectAutomationConfig'
]
...
ROOT_URLCONF = 'project_automation.urls'
...
WSGI_APPLICATION = 'project_automation.wsgi.application'
...
SENDER_EMAIL_LOGIN = env.str('SENDER_EMAIL_LOGIN')
